...
lf = locsw(ind-1)+1;
rf = locsw(ind)+1;
patch([Avec(sopt,lf),Avec(sopt,lf:rf),Avec(sopt,rf)], [100,hvec(sopt,lf:rf),100], Colors(ind,:),'FaceAlpha',0.35,'LineStyle','none')
end
...
lf = locsw(ind-1)+1;
rf = locsw(ind)+1;
patch([Avec(sopt,lf),Avec(sopt,lf:rf),Avec(sopt,rf)], [100,Mvec(sopt,lf:rf),100], Colors(ind,:),'FaceAlpha',0.35,'LineStyle','none')
end
